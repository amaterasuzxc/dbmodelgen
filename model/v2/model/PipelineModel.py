...
class PipelineModel:
    def __init__(self, config_path: str) -> None:
        ...
        self._model.add_pipe("lemmatizer", source=self._lemmatizer, last=True)
    ...
    def _assemble_json(self, doc: Doc) -> Dict[str, Any]:
        json_doc = doc.to_json()
        json_doc["relations"] = doc._.rel.items()
        json_doc["categories"] = doc._.ecat.items()

        return json_doc

    # def apply(self, text: str) -> Dict[str, Any]:
    def apply(self, text: str) -> Doc:
